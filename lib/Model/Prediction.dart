...
class Prediction {
  ...
  Future<String> gdm(
    ...
    if (age.isNotEmpty &&
      ...
      var uri = Uri.parse("https://gdm-model.herokuapp.com/predict");
  ...
  Future<String> maternalhealthrisk({
    ...
    if (age.isNotEmpty &&
      ...
      var client = new http.Client();
      var uri = Uri.parse("https://rapport-hp.herokuapp.com/predict");
      Map<String, String> headers = {"Content-type": "application/json"};
      String jsonString = json.encode(body);
      try {
        var resp = await client.post(uri, headers: headers, body: jsonString);
  ...
  Future<String> anemiadetection({
    ...
    if (Hemoglobin.isNotEmpty &&
      ...
      var client = new http.Client();
      var uri = Uri.parse("https://anemiaa.herokuapp.com/predict");
      Map<String, String> headers = {"Content-type": "application/json"};
      String jsonString = json.encode(body);
      try {
        var resp = await client.post(uri, headers: headers, body: jsonString);
